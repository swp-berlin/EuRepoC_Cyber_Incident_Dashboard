...
order_df.to_csv("/home/ubuntu/app_data/eurepoc_dataset.csv", index=False)

with open("/home/ubuntu/app_data/full_data_dict.pickle", "wb") as file:
...
with open("/home/ubuntu/app_data/full_data_dict_index_map.pickle", "wb") as file:
