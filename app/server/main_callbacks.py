...
def reset_button_callback(app):
    ...
    def on_button_click(n_clicks):
        if n_clicks is not None:
            return "Global (states)", None, date(2000, 1, 1), date(today.year, today.month, today.day)
...
def tab_change_callback(app):
    ...
    def tab_content(active_tab):
        if active_tab == "tab-1":
            return map_tab, {'display': 'block'}, {'display': 'none'}, {'display': 'block'}, {'display': 'block'}
        elif active_tab == "tab-2":
            return network_tab, {'display': 'none'}, {'display': 'block'}, {'display': 'none'}, {'display': 'none'}
        elif active_tab == "tab-3":
            return timeline_tab, {'display': 'block'}, {'display': 'none'}, {'display': 'block'}, {'display': 'block'}
        elif active_tab == "tab-4":
            return types_tab, {'display': 'block'}, {'display': 'none'}, {'display': 'block'}, {'display': 'block'}
        elif active_tab == "tab-5":
            return sectors_tab, {'display': 'block'}, {'display': 'none'}, {'display': 'block'}, {'display': 'block'}
        elif active_tab == "tab-6":
            return "This is tab {}".format(active_tab), {'display': 'block'}, {'display': 'none'}, {'display': 'block'}, {'display': 'block'}
