...
def filter_datatable(
    ...
    filtered_data = copied_df.loc[copied_df['start_date'].isin(date_range)]
    ...
    if types_clickdata:
        if types_clickdata['points'][0]['customdata'][0] == "Data theft":
            filtered_data = filtered_data.loc[
                ~filtered_data['incident_type'].str.contains('Data theft & Doxing') & filtered_data['incident_type'].str.contains(
                    'Data theft')]
        else:
            filtered_data = filtered_data[filtered_data['incident_type'].str.contains(
                types_clickdata['points'][0]['customdata'][0])]
