...
country_flags["country_name"].append("Not attributed")
country_flags["flag"].append("Not attributed")
country_flags["code"].append(np.nan)
...
states_codes_lists = {
    ...
    "China", "Georgia", "India", "Indonesia", "Iran, Islamic Republic of", "Iraq", "Israel", "Japan", "Jordan",
    "Kazakhstan", "Kuwait", "Kyrgyzstan", "Laos", "Lebanon", "Malaysia", "Maldives", "Mongolia",
    "Myanmar", "Nepal", "Korea, Democratic People's Republic of", "Oman", "Pakistan", "Palestine", "Philippines", "Qatar",
    "Saudi Arabia", "Singapore", "Korea, Republic of", "Sri Lanka", "Syria", "Taiwan", "Tajikistan",
    ...
    "NAF": ["Algeria", "Egypt", "Libya", "Morocco", "Sudan", "Tunisia", "Western Sahara"],
    "NEA": ["China", "Japan", "Mongolia", "Korea, Democratic People's Republic of", "South Korea", "Taiwan"],
    "OC": ["Australia", "Fiji", "Kiribati", "Marshall Islands", "Micronesia", "Nauru",
    ...
    "SCS": ["Brunei", "China", "Indonesia", "Malaysia", "Philippines", "Taiwan", "Vietnam"],
    ...
    "Central African Republic", "Chad", "Comoros", "Congo, the Democratic Republic of the", "Congo",
...
def network_graph_callback(app, df=None, states_codes=None):
    ...
    def network_graph(receiver_country):
        ...
        def prep_network_data(data, country_type, country, filtered_region, table_head):
            ...
            if filtered_region in states_codes_lists.keys():
                full_network = full_network[full_network["receiver_country"].isin(states_codes_lists[filtered_region])]
